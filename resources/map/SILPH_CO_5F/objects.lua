...
map.createObject(2, 4).setSprite("ball").onUse(function(player) attemptToPickupObject("SILPH_CO_5F_2_4", "TM 09") end)
map.createObject(4, 11).setSprite("ball").onUse(function(player) attemptToPickupObject("SILPH_CO_5F_4_11", "PROTEIN") end)
map.createObject(21, 1).setSprite("ball").onUse(function(player) attemptToPickupObject("SILPH_CO_5F_21_1", "CARD KEY") end)
