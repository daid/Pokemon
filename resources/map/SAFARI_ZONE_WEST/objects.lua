map.createObject(8, 5).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "SAFARI_ZONE_WEST_8_5", "MAX POTION") end)
map.createObject(9, 18).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "SAFARI_ZONE_WEST_9_18", "TM 32") end)
map.createObject(18, 7).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "SAFARI_ZONE_WEST_18_7", "MAX REVIVE") end)
map.createObject(19, 18).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "SAFARI_ZONE_WEST_19_18", "GOLD TEETH") end)
