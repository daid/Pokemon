...
map.createObject(16, 8).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "UNKNOWN_DUNGEON_3_16_8", "ULTRA BALL") end)
map.createObject(18, 16).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "UNKNOWN_DUNGEON_3_18_16", "MAX REVIVE") end)
