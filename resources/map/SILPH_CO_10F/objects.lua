...
map.createObject(2, 5).setSprite("ball").onUse(function(player) attemptToPickupObject("SILPH_CO_10F_2_5", "TM 26") end)
map.createObject(4, 3).setSprite("ball").onUse(function(player) attemptToPickupObject("SILPH_CO_10F_4_3", "RARE CANDY") end)
map.createObject(5, 6).setSprite("ball").onUse(function(player) attemptToPickupObject("SILPH_CO_10F_5_6", "CARBOS") end)
