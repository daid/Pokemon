...
map.createObject(7, 10).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "POWER_PLANT_7_10", "CARBOS") end)
map.createObject(28, 32).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "POWER_PLANT_28_32", "HP UP") end)
map.createObject(34, 32).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "POWER_PLANT_34_32", "RARE CANDY") end)
map.createObject(26, 3).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "POWER_PLANT_26_3", "TM 25") end)
map.createObject(20, 3).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "POWER_PLANT_20_3", "TM 33") end)
