...
map.createObject(10, 25).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "MANSION_4_10_25", "RARE CANDY") end)
map.createObject(1, 5).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "MANSION_4_1_5", "FULL RESTORE") end)
map.createObject(19, 2).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "MANSION_4_19_2", "TM 14") end)
map.createObject(5, 23).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "MANSION_4_5_23", "TM 22") end)
map.createObject(16, 7).setSprite("book_map_dex")--[[['7 ; person']--]]
map.createObject(5, 14).setSprite("ball").onUse(function(player) attemptToPickupObject(player, "MANSION_4_5_14", "SECRET KEY") end)
